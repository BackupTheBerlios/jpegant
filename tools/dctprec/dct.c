...
void dct_1d_31(short pixels[8], short data[8])
{
	...
	data[1] = (C1*d07 + C3*d16 + C5*d25 + C7*d34) >> 15;
	data[3] = (C3*d07 - C7*d16 - C1*d25 - C5*d34) >> 15;
	data[5] = (C5*d07 - C1*d16 + C7*d25 + C3*d34) >> 15;
	data[7] = (C7*d07 - C5*d16 + C3*d25 - C1*d34) >> 15;
	...
	data[0] = (C4*(s0734 + s1625)) >> 15;
	data[4] = (C4*(s0734 - s1625)) >> 15;

	data[2] = (C2*d0734 + C6*d1625) >> 15;
	data[6] = (C6*d0734 - C2*d1625) >> 15;
}
